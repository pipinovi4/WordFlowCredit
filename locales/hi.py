...
L10N_HI = {
    ...
    "menu_title": "🧭 WorldFlow Credit — आपका वित्तीय नेविगेटर। चुनें: आवेदन, सहायता, जानकारी या आपके मामले।",
    ...
    "support_text": (
        ...
        "— जटिल परिस्थितियों को सुलझाएँ,\n"
        "— सर्वोत्तम कदम सुझाएँ,\n"
        "— आपको सही विशेषज्ञ से जोड़ें।\n\n"
        "📲 आपका व्यक्तिगत सहायता चैनल: <b>@WorldFlowSupport</b>"
    ),
    ...
    "back_to_region": (
        ...
        "ताकि हम आपको सबसे उपयुक्त उत्पाद और फॉर्म दिखा सकें।"
    ),
    "btn_back": "↩ वापस",
    "btn_website": "वेबसाइट",
